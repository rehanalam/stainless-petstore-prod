import fs from 'fs';
import type { ResponseLike } from 'rehan-petstore/internal/to-file';
import { toFile } from 'rehan-petstore/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('rehan-petstore/core/uploads');
    await expect(
